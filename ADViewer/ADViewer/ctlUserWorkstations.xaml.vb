...
Public Class ctlUserWorkstations
    ...
    Private Shared Sub CurrentObjectPropertyChanged(d As DependencyObject, e As DependencyPropertyChangedEventArgs)
        ...
        With instance
            ...
            If ._currentobject IsNot Nothing Then ._currentselectedobjects = .searcher.BasicSearchSync("""" & Join(._currentobject.userWorkstations, """/""") & """", ._currentobject.Domain,, False, True, False, False)
    ...
    Private Async Sub tbDomainObjectsFilter_KeyDown(sender As Object, e As KeyEventArgs) Handles tbDomainObjectsFilter.KeyDown
        If e.Key = Key.Enter Then
            _currentdomainobjects.Clear()
            Await searcher.BasicSearchAsync(_currentdomainobjects, tbDomainObjectsFilter.Text, _currentobject.Domain,, False, True, False, True)
        End If
    End Sub
